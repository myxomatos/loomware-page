...
const PATHS = {
  ...
  zap: (
    <path d="M13 2 4.5 13.5H11L10 22l8.5-11.5H13z" fill="currentColor" stroke="none" />
  ),
  sliders: (
    <>
      <path d="M4 6h9.5" />
  ...
  pencil: (
    <>
      <path d="M21.17 6.81a1 1 0 0 0-3.98-3.99L3.84 16.17a2 2 0 0 0-.5.83l-1.32 4.36a.5.5 0 0 0 .62.62l4.35-1.32a2 2 0 0 0 .83-.5z" />
      <path d="m15 5 4 4" />
    </>
  ),
  calendar: (
